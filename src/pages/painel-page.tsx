...
// import { DICIONARIO_APARELHOS } from "@/utils/aparelhos";
...
export default function PainelPage() {
  ...
  //             {ultimaNota.categoria} - {ultimaNota.aparelho}
  //           </h2>
  //         </div>

  //         <div className="flex flex-wrap items-center gap-2">
  //           <img src="/fmg-logo.jpg" alt="" className="size-14 md:size-18 rounded-xl" />
  //           <div className="bg-white rounded-xl size-14 md:size-18 flex items-center justify-center">
  //             <img
  //               src={aparelho?.imagem}
  //               alt={aparelho?.nomeCurto}
  //               className="size-12 md:size-16 object-contain"
  //             />
  //           </div>
  //           <div
  //             className="rounded-2xl border border-primary/30 bg-accent px-5 py-4 backdrop-blur-md text-primary"
  //           >
  ...
  //               <div className="mt-2 text-[4rem] sm:text-[5rem] lg:text-[6rem] font-black leading-none tracking-tight text-primary">
